...
const solutions: Solution[] = [
  ...
  },
  {
    ...
    folder: "iot",
    images: ["/solutions/iot/image-1.png", "/solutions/iot/image-2.png", "/solutions/iot/image-3.png"]
  },
  {
    id: "rag",
    name: "RAG",
...
export default function SolutionsPage() {
  ...
  // Set default to "cv" on mobile
  useEffect(() => {
    const isMobile = window.innerWidth < 1024; // lg breakpoint
    if (isMobile && !selectedSolution) {
      setSelectedSolution("cv");
    }
  }, []);
          ...
          >
            ...
            {selectedSolution && selected && (
              ...
              >
                ...
                <div className="hidden lg:flex gap-8 max-w-7xl mx-auto min-h-[600px]">
                  {/* Left: Buttons with Inline Descriptions - Scrollable */}
                  <motion.div
                    initial={{ x: 200, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.5, delay: 0.1 }}
                    className="flex flex-col gap-4 flex-shrink-0 max-h-[600px] overflow-y-auto pr-4 pb-3 custom-scrollbar"
                  >
                    {solutions.map((solution, index) => (
                ...
                <div className="lg:hidden flex flex-col gap-6 max-w-2xl mx-auto">
                    ...
                    {solutions.map((solution) => (
                      <button
                        ...
                        className={`flex-shrink-0 px-6 py-3 rounded-full font-plus-jakarta-sans font-bold text-sm whitespace-nowrap snap-center transition-all ${
                          solution.id === selectedSolution
                            ? 'bg-[#f8f6f3] border-2 border-[#EAE5D7] shadow-lg scale-105'
                            : 'bg-[#EAE5D7]'
                        }`}
                      >
                  ...
                  <motion.div
                    ...
                    className="bg-[#f8f6f3] border-2 border-[#EAE5D7] rounded-[48px] p-6 shadow-xl"
                  >
